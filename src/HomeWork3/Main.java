...
public class Main {
    public static void main(String[] args) {
        ...
        Lawyer lawyer = null;
        try {
            lawyer = new Lawyer("Boris", 0, 2);
        } catch (OldAgeException | YoungAgeException e) {
            e.printStackTrace();
        } catch (MyExceptions e) {
            e.printStackTrace();
        }
        //Worker worker2 = new Worker("John", 22, 20);
       // Manager manager1 = new Manager("Sam", 66, 23);
        //Manager manager2 = new Manager("Tomas", 18);
       // Manager manager3 = new Manager("Angela", 18, 22);
        Accountant accountant1 = new Accountant("Sam", -6);
